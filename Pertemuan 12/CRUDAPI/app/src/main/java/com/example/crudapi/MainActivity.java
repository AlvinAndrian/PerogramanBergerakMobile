...
import com.example.crudapi.Patch.UpdatePatchActivity;
import com.example.crudapi.Post.CreateInsertActivity;
import com.example.crudapi.Put.UpdatePutActivity;
...
import com.example.crudapi.SingleUsersNotFound.SingleUsersNFActivity;
...
public class MainActivity extends AppCompatActivity {
    Button listUsers, singleUsers, listUserResource,
            singleUserResource, post, put, patch, delete, singleUsersNotFound,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        put = findViewById(R.id.updatePut);
        patch = findViewById(R.id.updatePatch);
        ...
        singleUsersNotFound.setOnClickListener(v -> {
            startActivity(new Intent(MainActivity.this, SingleUsersNFActivity.class));
        });
